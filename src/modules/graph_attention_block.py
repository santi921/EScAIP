...
class GeneralEfficientGraphAttentionBlock(nn.Module):
    """
    General Efficient Graph Attention Block module.
    Ref: swin transformer
    """
    ...
    def __init__(
        ...
        # Graph attention
        self.graph_attention = GeneralEfficientGraphAttention(
            global_cfg=global_cfg,
            molecular_graph_cfg=molecular_graph_cfg,
            gnn_cfg=gnn_cfg,
            reg_cfg=reg_cfg,
    ...
    def forward(
        self,
        data: GeneralGraphAttentionData,
        node_features: torch.Tensor,
        edge_features: torch.Tensor,
    ):
        # ref: swin transformer https://github.com/pytorch/vision/blob/main/torchvision/models/swin_transformer.py#L452
...
class GeneralEfficientGraphAttention(GeneralBaseGraphNeuralNetworkLayer):
    """
    Efficient Graph Attention module.
    """
